...
const val RMS_LIST_SPACER = 20
const val RMS_NAME_LIST_POS_X = (RMS_WIDTH - RMS_LIST_WIDTH * 2 - RMS_LIST_SPACER) / 2
const val RMS_SCORE_LIST_POS_X = RMS_NAME_LIST_POS_X + RMS_LIST_WIDTH + RMS_LIST_SPACER
const val RMS_LIST_POS_Y = RMS_HEIGHT / 2

const val RMS_BTN_WIDTH = 100
const val RMS_BTN_HEIGHT = 50
const val RMS_REPLAY_BTN_POS_X = (RMS_WIDTH - RMS_BTN_WIDTH * 2) / 3
const val RMS_EXIT_BTN_POS_X = RMS_REPLAY_BTN_POS_X * 2 + RMS_BTN_WIDTH
const val RMS_BTN_POS_Y = RMS_LIST_POS_Y + RMS_LIST_HEIGHT + 50
